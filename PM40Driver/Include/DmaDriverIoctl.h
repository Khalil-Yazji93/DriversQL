...
#define USER_IRQ_CONTROL_IOCTL              0x843
...
// General IOCTL DMADriverEvtIoDeviceControl()
...
// User Interrupt IOCTLs
#define USER_IRQ_WAIT_IOCTL             CTL_CODE(FILE_DEVICE_UNKNOWN, 0x841, METHOD_OUT_DIRECT,    FILE_ANY_ACCESS)
#define USER_IRQ_CANCEL_IOCTL           CTL_CODE(FILE_DEVICE_UNKNOWN, 0x842, METHOD_OUT_DIRECT,    FILE_ANY_ACCESS)
#define USER_IRQ_CONTROL_IOCTL          CTL_CODE(FILE_DEVICE_UNKNOWN, 0x843, METHOD_OUT_DIRECT,    FILE_ANY_ACCESS)
...
typedef struct _BOARD_CONFIG_STRUCT {
        ...
        UINT16 DriverVersionMajor;       // Driver Major Revision number
        UINT16 DriverVersionMinor;       // Driver Minor Revision number
        UINT16 DriverVersionSubMinor;    // Driver Sub Minor Revision number 
        UINT16 DriverVersionBuildNumber; // Driver Build number
...
#define STATUS_DEVICEDRIVER_INCOMPATABLE_VER    0x80
#define STATUS_HANDLE_INVALID               0x100
...
#define DMA_CAP_DIRECTION_MASK              (DMA_CAP_SYSTEM_TO_CARD|DMA_CAP_CARD_TO_SYSTEM)
...
#define DMA_CAP_FIFO_PACKET_DMA             DMA_CAP_PACKET_DMA  // New definition of "Packet" mode
#define DMA_CAP_ADDRESSABLE_PACKET_DMA      0x00000020
#define DMA_CAP_ENGINE_TYPE_MASK            (DMA_CAP_PACKET_DMA|DMA_CAP_FIFO_PACKET_DMA|DMA_CAP_ADDRESSABLE_PACKET_DMA)
...
#define INVALID_RELEASE_TOKEN ((UINT32)(~0))
...
// USER_IRQ_CONTROL_STRUCT - Information passed in USER_IRQ_CONTROL_IOCTL
//
typedef struct _USER_IRQ_CONTROL_STRUCT {
    /*
     * If non-zero then enable user interrupts, otherwise disable.
     */
    UINT32  dwEnableUserIRQ;

} USER_IRQ_CONTROL_STRUCT, *PUSER_IRQ_CONTROL_STRUCT;
