...
typedef struct _DMA_COMMON_CONTROL_STRUCT {
    UINT32 ControlStatus;               // 0x4000
    UINT32 DMABackEndCoreVersion;       // 0x4004
    UINT32 PCIExpressCoreVersion;       // 0x4008
    UINT32 UserVersion;                 // 0x400c
    UINT8 Reserved1[0x8040-0x4010];
    UINT32 MgmtInterruptControl;        // 0x8040
    UINT8 Reserved2[0x8050-0x8044];
    UINT32 MgmtInterruptStatus;         // 0x8050
    UINT8 Reserved3[0x8060-0x8054];
    UINT32 UserIntControl;              // 0x8060
}
...
#define CARD_USER_INTERRUPT_MASK                    (CARD_USER_INTERRUPT_MODE|CARD_USER_INTERRUPT_ACTIVE)
